...
func TestIsValidURL(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			if got := youtube_short.IsValidURL(tc.input); got != tc.valid {
...
func TestGetID(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			got, err := youtube_short.GetID(tc.input)
...
func TestExtractURLs(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			input:    "invalid.com/123 and youtube.com/shorts/validID1234 and  https://vimeo.com/456 ",
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			got := youtube_short.ExtractURLs(tc.input)
