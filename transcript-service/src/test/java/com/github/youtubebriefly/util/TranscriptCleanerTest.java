...
public class TranscriptCleanerTest {
    ...
    void testCleanTranscript_TimelineAndText(String transcript, String expected) {
    ...
    void testCleanTranscript_NumericLinesAndText(String transcript, String expected) {
        assertEquals(expected, transcriptCleaner.cleanTranscript(transcript));
    }
    ...
    void testCleanTranscript_DuplicatesRemoved(String transcript, String expected) {
        assertEquals(expected, transcriptCleaner.cleanTranscript(transcript));
    }
    ...
    void testCleanTranscript_OnlyTimelines(String transcript, String expected) {
        assertEquals(expected, transcriptCleaner.cleanTranscript(transcript));
    }
    ...
    void testCleanTranscript_OnlyNumbers(String transcript, String expected) {
        assertEquals(expected, transcriptCleaner.cleanTranscript(transcript));
    }
    ...
    void testCleanTranscript_LeadingTrailingWhitespace(String transcript, String expected) {
        assertEquals(expected, transcriptCleaner.cleanTranscript(transcript));
    }

    @Test
    void testCleanTranscript_EmptyInput() {
